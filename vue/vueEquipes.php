...
<table>
	...
	<form action="./?action=equipes" method="POST">
...
<div class="container">
	<input type="hidden" name="numEquipe" value="<?php if (isset($afficher)) { echo $afficher['num_equipe']; } else { ?> <?php } ?>">

	<label name="nomequipe">{Nom d'Equipe :</label>
	<input type="text" name="txtNomEquipe" value="<?php if (isset($afficher)) { echo $afficher['nom_equipe']; } else { ?> <?php } ?>"></br>

	<label name="nomclub">{Nom du Club :</label>
	<select id="liste" name="listeclub">
		<option value="<?php if (isset($afficher)) { echo $afficher['num_club']; ?>"><?php echo $afficher['nom_club']; } else { ?><?php } ?></option>
	...
	<select id="listechamp" name="listechamp">
		<option value="<?php if (isset($afficher)) { echo $afficher['num_championnat']; ?>"><?php echo $afficher['nom_championnat']; } else { ?><?php } ?></option>
